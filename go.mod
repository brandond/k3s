...
replace (
	...
	k8s.io/api => github.com/brandond/kubernetes/staging/src/k8s.io/api v1.18.10-k3s1
	k8s.io/apiextensions-apiserver => github.com/brandond/kubernetes/staging/src/k8s.io/apiextensions-apiserver v1.18.10-k3s1
	k8s.io/apimachinery => github.com/brandond/kubernetes/staging/src/k8s.io/apimachinery v1.18.10-k3s1
	k8s.io/apiserver => github.com/brandond/kubernetes/staging/src/k8s.io/apiserver v1.18.10-k3s1
	k8s.io/cli-runtime => github.com/brandond/kubernetes/staging/src/k8s.io/cli-runtime v1.18.10-k3s1
	k8s.io/client-go => github.com/brandond/kubernetes/staging/src/k8s.io/client-go v1.18.10-k3s1
	k8s.io/cloud-provider => github.com/brandond/kubernetes/staging/src/k8s.io/cloud-provider v1.18.10-k3s1
	k8s.io/cluster-bootstrap => github.com/brandond/kubernetes/staging/src/k8s.io/cluster-bootstrap v1.18.10-k3s1
	k8s.io/code-generator => github.com/brandond/kubernetes/staging/src/k8s.io/code-generator v1.18.10-k3s1
	k8s.io/component-base => github.com/brandond/kubernetes/staging/src/k8s.io/component-base v1.18.10-k3s1
	k8s.io/cri-api => github.com/brandond/kubernetes/staging/src/k8s.io/cri-api v1.18.10-k3s1
	k8s.io/csi-translation-lib => github.com/brandond/kubernetes/staging/src/k8s.io/csi-translation-lib v1.18.10-k3s1
	k8s.io/kube-aggregator => github.com/brandond/kubernetes/staging/src/k8s.io/kube-aggregator v1.18.10-k3s1
	k8s.io/kube-controller-manager => github.com/brandond/kubernetes/staging/src/k8s.io/kube-controller-manager v1.18.10-k3s1
	k8s.io/kube-proxy => github.com/brandond/kubernetes/staging/src/k8s.io/kube-proxy v1.18.10-k3s1
	k8s.io/kube-scheduler => github.com/brandond/kubernetes/staging/src/k8s.io/kube-scheduler v1.18.10-k3s1
	k8s.io/kubectl => github.com/brandond/kubernetes/staging/src/k8s.io/kubectl v1.18.10-k3s1
	k8s.io/kubelet => github.com/brandond/kubernetes/staging/src/k8s.io/kubelet v1.18.10-k3s1
	k8s.io/kubernetes => github.com/brandond/kubernetes v1.18.10-k3s1
	k8s.io/legacy-cloud-providers => github.com/brandond/kubernetes/staging/src/k8s.io/legacy-cloud-providers v1.18.10-k3s1
	k8s.io/metrics => github.com/brandond/kubernetes/staging/src/k8s.io/metrics v1.18.10-k3s1
	k8s.io/node-api => github.com/brandond/kubernetes/staging/src/k8s.io/node-api v1.18.10-k3s1
	k8s.io/sample-apiserver => github.com/brandond/kubernetes/staging/src/k8s.io/sample-apiserver v1.18.10-k3s1
	k8s.io/sample-cli-plugin => github.com/brandond/kubernetes/staging/src/k8s.io/sample-cli-plugin v1.18.10-k3s1
	k8s.io/sample-controller => github.com/brandond/kubernetes/staging/src/k8s.io/sample-controller v1.18.10-k3s1
